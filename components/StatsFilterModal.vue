  ...
  <div class="filter-modal-overlay" @click.self="$emit('close')">
    <div class="filter-modal">
      <div class="filter-modal__header">
        <h3 class="filter-modal__title">{{ labels.title }}</h3>
      ...
      <div class="filter-modal__body">
        <div class="filter-modal__section">
          <h4 class="filter-modal__section-title">{{ labels.dateRange }}</h4>
          <div class="filter-modal__date-inputs">
            <div class="filter-modal__field">
              <label class="filter-modal__label">{{ labels.startDate }}</label>
              <input
            ...
            <div class="filter-modal__field">
              <label class="filter-modal__label">{{ labels.endDate }}</label>
              <input
          ...
          <div class="filter-modal__presets">
            ...
            >
              {{ labels.presets[preset.value] || preset.label }}
            </button>
          </div>
        </div>

        <div class="filter-modal__section">
          <h4 class="filter-modal__section-title">{{ labels.wallets }}</h4>
