  ...
  <div class="wallet-list-card" :class="{ 'is-default': isDefault }">
    <div class="card-actions">
      <div class="action-menu-container" @click.stop>
        <button class="action-menu" :title="labels.moreActions" @click="toggleMenu">
    ...
    <div class="wallet-header">
      ...
      <span v-if="isDefault" class="default-badge">{{ labels.default }}</span>
    </div>
    <span class="wallet-currency">{{ wallet.currency }}</span>

    <div class="balance-section">
      <span class="balance-label">{{ labels.balance }}</span>
    ...
    <div class="stats-section">
      <div class="stat income">
        ...
        <div class="stat-content">
          <span class="stat-label">{{ labels.income }}</span>
      ...
      <div class="stat expense">
        ...
        <div class="stat-content">
          <span class="stat-label">{{ labels.expense }}</span>
...
const getCurrencySymbol = (code) => {
  try {
    ...
    return parts.length ? parts[0].value : code || '';
  } catch {
    return code || '';
  }
};
