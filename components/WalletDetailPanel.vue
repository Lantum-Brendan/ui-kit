      ...
      <div :key="wallet.id" class="detail-body">
        ...
        <section class="totals">
          <div class="total total--balance">
            <span class="total-label">{{ labels.balance }}</span>
          ...
          <div class="total total--expense">
            <span class="total-label">{{ labels.expense }}</span>
        ...
        <section class="chart-card">
          <header class="chart-head">
            <div>
              <span class="chart-eyebrow">{{ labels.last6Months }}</span>
              <h3 class="chart-title">{{ labels.activity }}</h3>
            </div>
            <span class="chart-legend">
              <span class="legend-dot legend-dot--income" />{{ labels.income }}
              <span class="legend-dot legend-dot--expense" />{{ labels.expense }}
            </span>
          </header>
          <svg
            v-if="hasActivity"
              ...
              <div class="recent-row-left">
                ...
                <div class="recent-text">
                  <span class="recent-name">{{
                    tx.party || tx.description || tx.category || labels.transaction
                  }}</span>
