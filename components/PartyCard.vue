  ...
  <div class="party-card" :style="statusStyle">
    <div class="card-actions">
      <div class="action-menu-container" @click.stop>
        <button class="action-menu" :title="moreActionsLabel" @click="toggleMenu">
          <LucideMoreVertical />
        </button>
    ...
    <div class="financial-section">
      <div class="stat-row">
        <div class="stat received">
          ...
          <div class="stat-content">
            <span class="stat-label">{{ receivedLabel }}</span>
        ...
        <div class="stat spent">
          ...
          <div class="stat-content">
            <span class="stat-label">{{ spentLabel }}</span>
      ...
      <div v-if="party.receivedAmount > 0 || party.spentAmount > 0" class="last-activity">
        ...
        <span>{{ lastActivityLabel }}: {{ formatLastUpdated(party.lastUpdated) }}</span>
      </div>
    </div>
  </div>
</template>
...
const displayPartyType = computed(() => {
  ...
  const labelKey = type;
  return props.typeLabels[labelKey] ? props.typeLabels[labelKey] : props.party.type;
});
