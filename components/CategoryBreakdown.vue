<template>
  <div class="category-breakdown">
    <div class="header">
      <h3 class="title">{{ labels.spendingOverview }}</h3>
      ...
      <div v-if="activeChart === 'pie'" class="chart-container">
        <div class="donut-wrapper">
          ...
          <div class="donut-center">
            <span class="center-label">{{ labels.total }}</span>
...
const formatTotal = computed(() => {
  return formatCompactCurrency(totalExpenses.value, props.defaultCurrency || 'USD');
});
