  ...
  <div class="entity-header surface surface--brand">
    ...
    <div class="header-content">
        ...
        <div class="title-row">
          ...
          <div class="title-text">
            <span class="breadcrumb-current">
              <span class="breadcrumb-home" @click="$emit('navigate-home')">{{ labels.home }}</span>
              <ChevronRight :size="11" class="breadcrumb-arrow" />
              <span>{{ pageNamePluralText }}</span>
            </span>
      ...
      <div class="action-buttons">
        ...
        <TButton
          v-if="showAddButton"
          :text="buttonText || fill(labels.addItem, { item: pageNameText.toLowerCase() })"
