<template>
  <div class="transaction-filters">
    <div class="filters-panel">
      <button type="button" class="filters-close" :aria-label="labels.close" @click="$emit('close')">
      ...
      <div class="filters-row">
        ...
        <div class="filter-group filter-group--type">
          <label class="filter-label">{{ labels.type }}</label>
        ...
        <div class="filter-group filter-group--dates">
          <label class="filter-label">{{ labels.dateRange }}</label>
      ...
      <div class="filters-row">
        ...
        <div class="filter-group">
          <label class="filter-label">{{ labels.wallets }}</label>
          <SearchableDropdown
            :options="wallets"
            :model-value="localFilters.wallet_ids || []"
            :multiple="true"
            :placeholder="labels.allWallets"
            option-label="name"
            option-key="id"
        ...
        <!-- Category filter -->
        <div class="filter-group">
          <label class="filter-label">{{ labels.category }}</label>
          <SearchableDropdown
            :options="categories"
