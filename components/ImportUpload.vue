      ...
      <div class="upload-content">
        ...
        <div class="upload-row">
          <div class="upload-options">
            <label class="upload-options__label">{{ labels.documentType }}</label>
            <select v-model="documentType" class="upload-options__select">
              <option value="">{{ labels.autoDetect }}</option>
              <option value="bank_statement">{{ labels.bankStatement }}</option>
              <option value="receipt">{{ labels.receipt }}</option>
              <option value="invoice">{{ labels.invoice }}</option>
              <option value="pay_stub">{{ labels.payStub }}</option>
              <option value="utility_bill">{{ labels.utilityBill }}</option>
            </select>
          </div>
          ...
          <button
            ...
            @click="handleUpload"
          >
            {{ isAnalyzing ? labels.analyzing : labels.analyzeDocument }}
          </button>
        </div>
      </div>
    </div>
