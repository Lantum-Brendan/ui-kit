            ...
            <tr :class="rowClass(suggestion)">
              ...
              <td>
                ...
                <span v-if="suggestion.party && !suggestion.party_id" class="inline-hint">
                  {{ labels.suggested }}: {{ suggestion.party }}
                </span>
              </td>
              <td>
                <select
                ...
                <span v-if="suggestion.category && !suggestion.category_id" class="inline-hint">
                  {{ labels.suggested }}: {{ suggestion.category }}
                </span>
              </td>
              <td>
                <select
              ...
              <td class="col-duplicate">
                ...
                >
                  {{ labels[duplicateLabel(suggestion.duplicate.match_type)] }}
                  <ChevronDownIcon
            ...
            >
              <td colspan="10">
                <div class="duplicate-detail">
                  <span class="duplicate-detail__label">{{ labels.existingTransaction }}:</span>
