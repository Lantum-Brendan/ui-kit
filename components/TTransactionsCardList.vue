      ...
      >
        <div class="txn-card__top">
          ...
          <div class="header-line">
            ...
            <span v-if="txn.isTransfer" class="transfer-indicator">{{ labels.transfer }}</span>
            <span v-if="txn.isRefund" class="refund-indicator">{{ labels.refund }}</span>
        ...
        <div class="txn-card__middle">
          ...
          >
            ...
            <span class="txn-chip__text">{{
              isDefaultWallet(txn) ? labels.default : txn.wallet || '—'
            }}</span>
          </span>
        </div>
...
const props = defineProps({
  ...
  defaultWallet: { type: Object, default: null },
  formatShortAmount: { type: Function, required: true },
  labels: {
    type: Object,
    default: () => ({
